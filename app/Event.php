...
{
	protected $fillable = [
		'user_id', 'organizer', 'start_time','end_time', 'event_name', 'description', 'rundown',  'event_type', 'event_category','ticket_price', 'total_seats', 'total_snacks', 'snack_choices', 'facilities', 'layout_seat', 'note', 'image', 'status'
	];
