...
{
	protected $fillable = [
		'user_id', 'organizer', 'date', 'start_time','end_time', 'description', 'rundown', 'event_name', 'event_type', 'event_category', 'total_seats', 'total_snacks', 'snack_choices', 'facilities', 'layout_seat', 'note', 'image', 'status'
	];
